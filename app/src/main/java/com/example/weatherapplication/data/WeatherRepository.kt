...
interface WeatherRepository {
    ...
    suspend fun getLocationDataWithLocationKey(apikey: String, locationKey: String): Flow<Result<LocationData>>
    ...
    suspend fun getKeyByTextSearch(apikey: String, q: String): Flow<Result<List<SearchValues>>>
